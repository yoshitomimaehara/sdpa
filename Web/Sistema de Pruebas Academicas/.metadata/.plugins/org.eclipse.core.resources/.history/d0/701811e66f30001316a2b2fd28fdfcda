...
<body>
	...
	<c:if test="${requestScope.error != null}">
		...
		<tr><td><c:out value="${requestScope.alumno.getCodalumno()"}></c:out></td><td>al.getNombre()</td><td>al.getApellido()</td><td>al.getCiclo()</td><td>al.getUniversidad()</td><td>al.getFech_nac()</td><td>al.getCreditos()</td><td>al.getAño_ingreso()</td></tr>
		</table>
	</c:if>
</body>
</html>